...
- 개발(PC 브라우저): `client`에서 `npm run dev` 후 `http://localhost:5173/tablet.html`
- **같은 Wi‑Fi의 태블릿**: PC의 사설 IP로 `http://192.168.x.x:5173/tablet.html` (Vite는 `client/vite.config.ts`의 `server.host: true`로 LAN 접속 허용)
